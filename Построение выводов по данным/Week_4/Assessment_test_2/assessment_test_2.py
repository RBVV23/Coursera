...
print('Количество отвернутых нулевых гипотез (p-value < 0.05) с учетом поправки Йетса:', n_corrected)
print('Количество отвернутых нулевых гипотез (p-value < 0.05) при использовании точного критерия Фишера:', n_corrected)
print()
