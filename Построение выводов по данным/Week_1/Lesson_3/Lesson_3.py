...
print('Доверительный интервал для разности долей (несвязанные выборки): [{}; {}]'.format(bound[0],
                                                                                         bound[1]))

new_bound = my_proportions_confint_diff_rel(data.banner_a, data.banner_b)
print('Доверительный интервал для разности долей (связанные выборки): [{}; {}]'.format(new_bound[0],
                                                                                       new_bound[1]))
