...
for n_trees in n_trees:
    estimator = ensemble.RandomForestClassifier(n_estimators=n_trees, min_samples_split=5, random_state=1)
...
# xgb_scoring = []
# for n_trees in n_trees:
#     estimator = xgb.XGBClassifier(learning_rate=0.1, max_depth=5, n_estimators=n_trees, min_child_weight=3)
#     score = model_selection.cross_val_score(estimator, bioresponce_data, bioresponce_target,
#                                             scoring='accuracy', cv=3)
